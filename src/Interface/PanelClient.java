...
public class PanelClient extends JPanel implements ActionListener {
	...
	// Button
	private JButton btnPrendreRdV, btnModification, btnAddMateriel, btnModifierCeMateriel;
	...
	public PanelClient(MainFrame mf) {
		...
		for (int i = 0; i < this.nbMatofThisClient; i++) {
			...
			gbc_btnVP.gridx = 7;
			gbc_btnVP.gridy = i;
			panelMateriel.add(btnVoirPlus, gbc_btnVP);
		}
...
//		jtfNumSerieMat.setColumns(10);
		...
		this.btnVoirPlus.addActionListener(this);
...
//	/**
//	 * Met a jour les labels informatifs du matériel à partir de listMateriel et
//	 * indiceMat
//	 */
...
//	}
	...
	/**
	 * Met à jour les labels informatifs du matériel lors qu'il y a eut une
	 * modification
	 */
